...
public class Utility {
	...
	public static Date convertBigDecimalToDate(BigDecimal date) {
		...
		int mm = date.subtract(new BigDecimal(yyyy*10000)).divide(new BigDecimal(100)).intValue();
		int dd = date.subtract(new BigDecimal(yyyy*10000)).subtract(new BigDecimal(mm*100)).intValue();
...
//
//			  dd = date.subtract(new BigDecimal(yyyy*10000)).subtract(new BigDecimal(mm*100)).intValue();
//		  }
//		}
//		
//		GregorianCalendar gc = new GregorianCalendar();
...
//	}
	...
	public static void addMessageError (Exception e) {
		addMessage(new FacesMessage(FacesMessage.SEVERITY_ERROR,e.getClass().getSimpleName()+":"+e.getMessage(),""));
	}
	
	public static void addMessageError (String summary) {
		addMessage(new FacesMessage(FacesMessage.SEVERITY_ERROR,summary,""));
	}
	public static void addMessageWarning (String summary) {
		addMessage(new FacesMessage(FacesMessage.SEVERITY_WARN,summary,""));
	}
	public static void addMessageInfo (String summary) {
		addMessage(new FacesMessage(FacesMessage.SEVERITY_INFO,summary,""));
	}
